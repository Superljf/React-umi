const LOCAL_STORAGE_NAMESPACE = 'supervision';
...
const dataUtils = {
  ...
  maskText(string, leftLen, rightLen) {
    ...
    return strLen <= leftLen + rightLen
      ? string
      : `${string.substring(0, leftLen)}****${string.substring(strLen - rightLen - 1)}`;
  },
  range(start, end) {
    const array = [];
